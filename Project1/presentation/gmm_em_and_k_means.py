...
vis.visualize_data_with_true_mu_sigma(x1,y1,x2,y2,x3,y3,mu_true,sigma_true,10.0,color_data=False,title='Training_Data_With_True_Distribution', save_plot='True')

vis.clear_plot()

vis.visualize_data_with_true_mu_sigma(x1,y1,x2,y2,x3,y3,mu_true,sigma_true,10.0,color_data=True,title='Training_Data_With_True_Distribution-Color', save_plot='True')
