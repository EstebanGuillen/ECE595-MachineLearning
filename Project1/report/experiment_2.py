...
plt.clf()
vis.visualize_iterations_per_restart(iterations_for_each_restart_em, title='Iterations_per_Restart_with_Exit_Criteria - EM', delay=5.0,save_plot=True)

plt.clf()
vis.visualize_iterations_per_restart(iterations_for_each_restart_kmeans_maha, title='Iterations_per_Restart_with_Exit_Criteria - K-means (Maha)', delay=5.0, save_plot=True)

plt.clf()
vis.visualize_iterations_per_restart(iterations_for_each_restart_kmeans_eucl, title='Iterations_per_Restart_with_Exit_Criteria - K-means (Eucl)', delay=5.0, save_plot=True)
