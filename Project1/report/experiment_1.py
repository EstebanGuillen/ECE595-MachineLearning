...
L_em_average = 1/Restarts * np.sum(L_em_total,axis=0)
plt.clf()
vis.visualize_log_likelihood(L_em_average,title='Log_Likelihood_Average - EM',restart='Final', save_plot='True', delay=3)

#L_kmeans_average = 1/Restarts * np.sum(L_kmeans_total,axis=0)
#plt.clf()
#vis.visualize_log_likelihood(L_kmeans_average,title='Log_Likelihood_Average - K-means (Maha)',restart='Final', save_plot='True', delay=3)

D_kmeans_maha_average = 1/Restarts * np.sum(D_kmeans_maha_total,axis=0)
plt.clf()
vis.visualize_total_eucl_distance(D_kmeans_maha_average,title='Mahalanobis_Distance_Average - K-means',restart='Final', save_plot='True', delay=3)

D_kmeans_average = 1/Restarts * np.sum(D_kmeans_total,axis=0)
plt.clf()
vis.visualize_total_eucl_distance(D_kmeans_average,title='Euclidian_Distance_Average - K-means',restart='Final', save_plot='True', delay=3)
